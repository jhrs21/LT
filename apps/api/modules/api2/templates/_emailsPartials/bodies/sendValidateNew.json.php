<tr>
    <td valign="top" class="bodyContent">
        <div style="<?php include_partial('api2/emailsPartials/styles/bodyContentStyle') ?>">
            ...
            <b>%FULLNAME%<b/>,
            <br><br>
            Gracias por usar <b>LealTag</b>, a partir de este segundo empezarás a ser premiado por
            visitar los sitios que te gustan. Para validar tu cuenta ingresa en este 
            <b><a style="<?php include_partial('api2/emailsPartials/styles/linksStyle', array('fontColor' => '009ddf')) ?>"
                  href="%ROUTE%">LINK
                </a></b>:
        </div>
    </td>
...
<tr>
    <td valign="top" class="bodyContent">
        <div style="<?php include_partial('api2/emailsPartials/styles/bodyContentStyle') ?>">
            ...
            haciendo clic <a style="<?php include_partial('api2/emailsPartials/styles/linksStyle', array('fontColor' => '009ddf')) ?>" 
            ...
            escríbenos a 
            <a style="<?php include_partial('api2/emailsPartials/styles/linksStyle', array('fontColor' => '009ddf')) ?>" target="_blank" 
