    ...
    <div id="gtd-header-container" class="container">
        <div id="td_header">
            <ul>
                ...
                <li class="separador"></li>
                <!--<li><a target="blank" href="http://www.sucucho.com"><img height="35px" src="http://www.tudescuenton.com//static/theme/Ciudades/css/img/pestana_viajes.png"></a></li>-->
                ...
                <?php else: ?>
                    ...
                    <li id="ingresa" class='button text-shadow'>
                    ...
                    <div class="newlogin_all">
                        <form id="login-user-form" method="post" action="<?php echo url_for('@sf_guard_login') ?>" class="validator">
                            ...
                            <div class="newlogin_recordar">
                                ...
                                Recordar
                                <input class="newlogin_formbutton" type="submit" name="commit" value="Login">
                            </div>
                        </form>     
                    </div>
                </div>
