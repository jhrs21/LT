...
<script type="text/javascript">
   ...
   var paramsChart = {categoryField : "tags", domId: "ColumnChartTag", title: "Numero de tags por usuario"};
   var paramsGraph = [ 
       { title : "Personas", labelText : "[[percents]]%", valueField : "total", balloonText : "[[category]] tags: [[value]] ([[percents]]%)", 
           lineColor : "#009ddf", type : "column"
       }
    ];
   buildColumnChart(chartData, paramsChart, paramsGraph);
