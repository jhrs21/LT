    ...
    <div id="gtd-header-container" class="container">
        <div id="td_header">
            <ul>
                ...
                <li><a target="blank" href="http://www.sucucho.com"><img height="35px" style="padding: 0 10px;" src="http://www.tudescuenton.com//static/theme/Ciudades/css/img/newhd_sucucho_letters.png"></a></li>
            </ul>
            <ul id='header_nav'>
                <li class='current'>
                    <a href="<?php echo url_for('homepage') ?>" class="current" >Tu Negocio</a>
                </li>
                <li class='current'>
