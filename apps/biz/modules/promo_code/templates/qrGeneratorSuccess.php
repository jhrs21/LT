        ...
        <div id="signin-form-container" class="form-container-inner">
            ...
            <div class="content">
                ...
                <div class="instructions">
                    <h1>Instrucciones</h1>
                    <p>Este es un generador de tags únicos, cada vez que un cliente solicite escanear su código de LealTag presione el botón <b>GENERAR</b>. De esta manera el cliente podrá escanearlo al presionar el botón "escanear" desde la aplicación LealTag.</p><br>
