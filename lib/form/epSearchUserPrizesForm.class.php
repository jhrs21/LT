...
class epSearchUserPrizesForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            'user' => new sfWidgetFormInput(array(), 
                array(
                    ...
                    'data-bvalidator-msg' => 'Indica el email del usuario o el código de su tarjeta LealTag'
                )),
        ...
        $this->widgetSchema->setLabels(array('user' => 'Email o Tarjeta LealTag del cliente:', 'promo' => 'Promoción:'));
